...
const ScienceClubs = [
  {
    ...
    whatsapp:'',
    insta: 'https://www.instagram.com/psitiiser?igsh=eHQweGg2djYza29t',
  ...
  },
  {
    ...
    whatsapp:'',
    insta: 'https://www.instagram.com/csit_iisertvm?igsh=MWJ4enBydDVqaTB4cQ==',
  ...
  },
  {
    ...
    whatsapp:'',
    insta: 'https://www.instagram.com/proteus.iisertvm?igsh=MTZieXV4cXQ4cWM3Yg==',
  ...
  },
  {
    ...
    whatsapp:'',
    insta: 'https://www.instagram.com/cmitiisertvm?igsh=MWg0ZWFwN2g4cnI1OA==',
  ...
  },
  {
    ...
    whatsapp:'',
    insta: 'https://www.instagram.com/parseciisertvm?igsh=MTZ1M3YzZXJoeGsyOQ==',
    gradient: 'bg-gradient-to-b from-purple-200 to-purple-100'
  },
  {
    name: 'C^2IT',
    role: 'Coding Club',
    img: '/images/clubs/ccit.jpg', // Replace with your actual image filename
    desc: 'For the coding enthusiasts',
    whatsapp:'',
    insta: 'https://www.instagram.com/codingclubiisertvm?igsh=NzlxNnNkY2M2cGlj',
    gradient: 'bg-gradient-to-b from-gray-300 to-gray-200'
  },
  {
    name: 'ESI',
    role: 'Ecology Club',
    img: '/images/clubs/esi.jpg', // Replace with your actual image filename
    desc: 'For the ecology enthusiasts',
    whatsapp:'',
    insta: 'https://www.instagram.com/esi_iisertvm?igsh=MXQzaDY0cG1rdTk4Ng==',
    gradient: 'bg-gradient-to-b from-green-200 to-green-100'
  },

  {
    name: 'Compass',
    role: 'Earth and Environment Club',
    img: '/images/clubs/eesc.jpg', // Replace with your actual image filename
    desc: 'For the sustainability enthusiasts',
    whatsapp:'',
    insta: 'https://www.instagram.com/compassiisertvm?igsh=dWRtMzl5MGtqazEz',
    gradient: 'bg-gradient-to-b from-green-200 to-green-100'
  },
];

export default function SClubs() {
  const [selectedClub, setSelectedClub] = useState<number | null>(null);
  const [hoveredClub, setHoveredClub] = useState<number | null>(null);
  const [isMobile, setIsMobile] = useState(false);
  const [modalOpen, setModalOpen] = useState(false);
  const [modalClub, setModalClub] = useState<typeof ScienceClubs[0] | null>(null);
  ...
  const handleClubClick = (index: number) => {
    if (isMobile) {
      setModalClub(ScienceClubs[index]);
      setModalOpen(true);
    } else {
  ...
  const getCardTransform = (index: number) => {
    const totalCards = ScienceClubs.length;
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 py-8 md:py-16 px-4">
      ...
      <div className="text-center mb-8 md:mb-16">
        <div className="inline-block">
          ...
          <p className="text-gray-400 text-base md:text-lg">Discover the scientific spirits of our campus</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {ScienceClubs.map((club, index) => (
              <div
                key={index}
                className={`${
                  ScienceClubs.length % 2 !== 0 && index === ScienceClubs.length - 1
