...
export default function WClubs() {
  ...
  const getCardTransform = (index: number) => {
    const totalCards = WelfareClubs.length;
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 py-16 px-4">
      ...
      <div className="text-center mb-16">
        <div className="inline-block">
          <span className="text-red-500 text-sm font-semibold tracking-wider uppercase">Social Welfare</span>
          <h1 className="text-4xl md:text-6xl font-bold text-white mt-2 mb-4">
            CLUBS OF IISER TVM
          </h1>
          <p className="text-gray-400 text-lg">Discover the welfare enthusiasts of our campus</p>
        </div>
      </div>
