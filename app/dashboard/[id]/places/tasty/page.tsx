  ...
  return (
    <DashboardLayout>
      <div
        ...
        style={{ backgroundImage: "url('/images/tasty.jpg')" }}>
                ...
                <div key={index}>
                  ...
                  >
                    <div className="ml-8 mt-3 mb-4 transform transition-all duration-500 ease-in-out">
                      <div 
                        className="relative w-80 h-40 bg-cover bg-center rounded-lg overflow-hidden shadow-lg transform transition-transform duration-300 hover:scale-105"
        ...
        <div className="flex-1 flex items-center justify-center">
          ...
          >
            This is Tasty: another resturant that serves food: you can&apost order food from here online
          </div>
        </div>
      </div>
    </DashboardLayout>
